...
this.DS.seturl("https://walidpc.eu-gb.mybluemix.net/register2?user_name="+this.name+"&password="+pass+"&degree="+this.degree+"&user_email="+this.email+"&school="+school+"&phone_no="+phone+"&age="+this.age);  
